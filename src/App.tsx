    ...
    <>
      ...
      <div ref={bottomLeftContainerRef}>
        ...
        <nav className="bottom-left-actions" style={{ bottom: `${controlsBottomPx}px` }} aria-label="Canvas actions">
          ...
          <button className={`text-action-button text-action-button--adjust${activeBottomLeftMenu === 'adjust' ? ' active' : ''}`} type="button" aria-label="Adjust" disabled={isMagicFixView} onClick={() => toggleBottomLeftMenu('adjust')}>
            <img className="text-action-glyph adjust-glyph" src={adjustGlyph} alt="" aria-hidden="true" />
            <span>Adjust</span>
          </button>
          <button className={`text-action-button${activeBottomLeftMenu === 'effects' ? ' active' : ''}`} type="button" aria-label="Effects" disabled={isMagicFixView} onClick={() => toggleBottomLeftMenu('effects')}>
