...
function TrancheView({ displayImageSrc, placeholderColors, onOpenEditView, isImageHidden = false }: TrancheViewProps) {
  ...
  return (
    <main className="gallery-view-stage">
      <section
        ...
        aria-label="Tranche thumbnails"
      >
        {trancheTiles.map((tile, index) => (
          <button
